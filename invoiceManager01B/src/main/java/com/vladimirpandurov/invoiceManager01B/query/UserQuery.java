...
public class UserQuery {
    ...
    public static final String INSERT_VERIFICATION_CODE_QUERY = "INSERT INTO TwoFactorVerifications (user_id, code, expiration_data) VALUES (:userId, :code, :expirationDate)";
    ...
    public static final String SELECT_CODE_EXPIRATION_QUERY = "SELECT expiration_data < NOW() FROM TwoFactorVerifications WHERE code = :code";
    ...
    public static final String INSERT_PASSWORD_VERIFICATION_QUERY = "INSERT INTO ResetPasswordVerifications (user_id, url,  expiration_data) VALUES (:userId, :url, :expirationDate)";
